...
- Tasks 5, 6, 19-25: not started. Next: Batch 8 = Task 19 (scaling + unit conversion), Task 20 (shopping list; reuse `useLocalStorage` from src/lib/use-local-storage.ts and `Amount`/`convertUnit` from Task 19).
