...
- Tasks 5, 6, 21-25: not started. Next: Batch 9 = Task 21 (ingredient pages), Task 22 (view tracking + insights - needs new `RecipeDailyStat` model + migration; REMINDER: use `prisma migrate dev --create-only` + `prisma migrate deploy`, never bare `migrate dev`).
